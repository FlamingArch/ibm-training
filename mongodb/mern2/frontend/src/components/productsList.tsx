...
const ProductsList = () =>{
   ...
   const{products} =useSelector((state:RootState)=>({
        products:state.products.products //state.products will contain the key, therefore to fetch the products we have to do an extra .products
    }))
    ...
    // //     const response = await httpClient.get('http://localhost:9999/api/products')
