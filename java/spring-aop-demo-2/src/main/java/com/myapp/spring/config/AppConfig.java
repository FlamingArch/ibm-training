...
////	@Bean
////	Map<Integer, Product> map(){
//////		return Map.of(1, new Product(1, "Iphone15", 75456.5),	//here we can never modify a map
//////				2, new Product(3,"Oneplus12R",65456.5), 3, new Product(2, "SamsungFlip", 105456.5));
//////	}
////		Map<Integer, Product> productMap = new HashMap<>();
////		productMap.put(1, new Product(1, "Iphone15", 75456.5));
////		productMap.put(2, new Product(2, "Oneplus12R", 65456.5));
